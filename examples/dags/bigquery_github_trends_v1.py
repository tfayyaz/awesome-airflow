...
# bq mk --time_partitioning_type=DAY airflow-cloud-public-datasets:github_trends.github_daily_metrics
# bq mk --time_partitioning_type=DAY airflow-cloud-public-datasets:github_trends.github_agg
# bq mk --time_partitioning_type=DAY airflow-cloud-public-datasets:github_trends.hackernews_agg
# bq mk --time_partitioning_type=DAY airflow-cloud-public-datasets:github_trends.hackernews_github_agg
